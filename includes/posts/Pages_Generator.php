...
class PluginsAlpha_Pages_Generator {
  public static function render(): void {
    $opt = PluginsAlpha_Settings::get(); ?>
        <div class="wrap pga-wrap pga-layout">
          <div class="pga-main">
            ...
            <?php
                if (!PluginsAlpha_LicenseEnforcement::license_active()) {
                  echo '<div class="notice notice-error" style="margin-top:15px">
                    <p><strong>⚠️ Plugins Alpha:</strong> Para gerar ou agendar posts, é necessário ativar sua licença.</p>
                    <p><a href="' . esc_url(admin_url('admin.php?page=plugins-alpha-settings')) . '" class="button button-primary">Ativar licença</a></p>
                  </div>';
                }
            ?>
            <div class="pga-card">
    ...
    public static function generate_and_insert(array $args, array $settings = []) {
        ...
        $tmpTimeout = function($t){ return max((int)$t, 120); };
