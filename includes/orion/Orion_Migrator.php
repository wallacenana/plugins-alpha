...
class PluginsAlpha_Orion_Migrator
{
    ...
    public static function on_transition_status(string $new, string $old, \WP_Post $post): void
    {
        ...
        // if (!PluginsAlpha_License::is_lifetime('alpha_orion')) return;
    ...
    public static function handle_migrate_legacy(): void
    {
        ...
        ], admin_url('admin.php?page=plugins-alpha-orion-prompts')); // <-- ajuste pro seu slug de página
    ...
    public static function handle_dismiss_notice(): void
    {
        ...
        $redirect = admin_url('admin.php?page=plugins-alpha-orion-prompts'); // <-- ajuste pro seu slug de página
        wp_safe_redirect($redirect);
        exit;
    }
}
